...
#define bleServerName "BMP388_ESP32"

/* UUID's of the service, characteristic that we want to read*/
// BLE Service
static BLEUUID bmpServiceUUID("84f6b8d6-ae43-11ed-afa1-0242ac120002");

// BLE Characteristics
//#ifdef temperatureCelsius
  //Temperature Celsius Characteristic
  static BLEUUID temperatureCharacteristicUUID("a34376c6-ae43-11ed-afa1-0242ac120002");
//#else
...
static BLEUUID pressureCharacteristicUUID("ae9530f0-ae43-11ed-afa1-0242ac120002");
...
//Flags to check whether new temperature and pressure readings are available
...
bool connectToServer(BLEAddress pAddress) {
  ...
  BLERemoteService* pRemoteService = pClient->getService(bmpServiceUUID);
  if (pRemoteService == nullptr) {
    Serial.print("Failed to find our service UUID: ");
    Serial.println(bmpServiceUUID.toString().c_str());
    return (false);
  }
